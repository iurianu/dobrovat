...
(function($) {
    ...
    $.fn.bsgdprcookies = function(options, event) {
        ...
        var settings = $.extend({
            ...
            advancedTitle: 'Modific&atilde; preferin&tcedil;ele cookie:',
            ...
            advancedCookiesToSelect: [
                ...
                },
                {
                    ...
                    description: 'Acestea sunt module de tip cookie legate de preferinţele dumneavoastră pentru website, cum ar fi reţinerea numelui de utilizator, nuanţelor preferate etc.',
                    isFixed: false
                },
                {
                    name: 'analytics',
        ...
        if(!cookieShow || !cookiePreferences || event == 'reinit') {
            ...
            var modal = '<div class="modal fade ' + settings.class + '" id="' + settings.id + '" tabindex="-1" role="dialog" aria-labelledby="' + settings.id + '-title" aria-hidden="true"><div class="modal-dialog modal-dialog-centered modal-extended" role="document"><div class="modal-content"><div class="modal-header"><h5 class="modal-title w-100 text-center" id="' + settings.id + '-title">' + settings.title + '</h5></div><div id="' + settings.id + '-body" class="modal-body" ' + modalBodyStyle + '>' + modalBody + '</div><div class="modal-footer">' + modalButtons + '</div></div></div></div>';
